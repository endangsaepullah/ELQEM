"""
database.py — SQLite persistent dengan connection pooling yang benar.
"""
import sqlite3
import os

DB_PATH = "/tmp/pindad_iqle.db"
_initialized = False


def get_connection():
    """Buat koneksi baru setiap call — SQLite thread-safe dengan check_same_thread=False."""
...
def init_database():
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS batch_production (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS defect_records (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS iso9001_evaluation (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS iatf16949_evaluation (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        eval_date TEXT NOT NULL, batch_number TEXT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS engineering_lifecycle (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        eval_date TEXT NOT NULL, batch_number TEXT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS quality_consistency (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        eval_date TEXT NOT NULL, batch_number TEXT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS interview_data (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS about_platform (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        key TEXT UNIQUE NOT NULL, value TEXT,
        updated_at TEXT DEFAULT (datetime('now')))""")

    c.execute("""CREATE TABLE IF NOT EXISTS about_photo (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        filename TEXT, photo_data BLOB,
        mime_type TEXT DEFAULT 'image/jpeg',
        uploaded_at TEXT DEFAULT (datetime('now')))""")

    c.execute("""CREATE TABLE IF NOT EXISTS login_logo (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
