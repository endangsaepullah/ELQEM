...
def seed_dummy_data():
    ...
    for u in [
        ...
        try:
            c.execute("INSERT INTO users (username,password_hash,full_name,role,email) VALUES(?,?,?,?,?)", u)
        except Exception:
            pass
    ...
    for row in [
        ('2024-03-10', 'Ir. Bambang Suryadi', 'Kepala Divisi Produksi', 'Divisi Manufaktur',
         'Engineering lifecycle menjadi faktor kritis. Perubahan desain yang tidak terkontrol menjadi sumber utama defect pada tahap assembly.',
         'Change control perlu diperkuat', 'Engineering Lifecycle', 'Peneliti'),
        ('2024-03-15', 'Dr. Retno Wulandari', 'Manajer QA', 'Quality Assurance',
         'Implementasi IATF 16949 sudah berjalan namun supplier quality masih menjadi tantangan utama.',
